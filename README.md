...
*(**NOTE:**  This example above contains more than the minimum required fields.  The minimum required fields are outlined in Section 6 below.)*
...
|course|The course of the platform as true direction (relative to true north).  At least six significant figures are recommended.|Degrees|
